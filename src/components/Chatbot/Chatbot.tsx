...
const Chatbot = () => {
  ...
  return (
    <>
      <div
        className={`fixed bottom-24 right-6 z-50 flex h-[500px] w-[360px] flex-col overflow-hidden rounded-2xl  bg-white shadow-2xl transition-[opacity,transform] duration-300 ease-out ${
          isOpen
